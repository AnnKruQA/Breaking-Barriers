...
<img src="../Images/Senses_and_constraints_Microsoft_Accessibility_Toolkit.png" alt="A group of people in rows, divided according to the senses (touch, see, hear, speak) and divided into three categories: permanent, temporary, and situational constraints." width="100%">
